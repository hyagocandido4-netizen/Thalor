...
from .summary_paths import sanitize_asset, sanitize_interval, repo_asset, repo_interval_sec
...
def repo_scope(*, config_path: str = 'config.yaml', default_asset: str = 'UNKNOWN', default_interval_sec: int = 300) -> RuntimeScope:
    asset = repo_asset(config_path=config_path, default=default_asset)
    interval_sec = repo_interval_sec(config_path=config_path, default=default_interval_sec)
